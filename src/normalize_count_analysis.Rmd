...
* normalizes the counts to transcripts per million for each sample using function `calculate_cpm`
* makes a "tidy" or long-format dataset with counts and TPM spread out by Geneid and Sampleid and sample information
...
file_counts_long <- "../results_counts/quantseqfwd_EH_050221_tidy.txt.gz"
