...
ggVennDiagram(hr0,  
              ...
              label_alpha = 0, 
              category.names = c("Gat201_ChipSeq","0h-Up","0h-Down")) +
...
venn30 <- ggVennDiagram( min30,  
               edge_lty = "dashed", edge_size = 1.2, 
               label_alpha = 0, 
               category.names = c("Gat201_ChipSeq","30m-Up","30m-Down")) +
               scale_fill_gradient(low= "#F4FAFE",high = "#4981BF") +
               labs(title = "CHipSeq-Gat201_RNASeq at 30 min")+
               theme(legend.title = element_text(color = "black"),
                      legend.position = "bottom")
venn30
...
ggVennDiagram( hr2,  
               edge_lty = "dashed", edge_size = 1.2, 
               label_alpha = 0,
               category.names = c("Gat201_ChipSeq","2h-Up","2h-Down")) +
               scale_fill_gradient(low= "#F4FAFE",high = "#4981BF") + 
...
ggVennDiagram( hr4,  
               edge_lty = "dashed", edge_size = 1.2, 
               label_alpha = 0, 
               category.names = c("Gat201_ChipSeq","4h-Up","4h-Down")) +
               scale_fill_gradient(low= "#F4FAFE",high = "#4981BF") + 
...
ggVennDiagram(hr0,  
              edge_lty = "dashed", edge_size = 1.2, 
              label_alpha = 0, 
              category.names = c("Gat204_ChipSeq","0h-Up","0h-Down")) +
              scale_fill_gradient(low= "#F4FAFE",high = "#4981BF") +
...
venn30 <- ggVennDiagram( min30,  
               edge_lty = "dashed", edge_size = 1.2, 
               label_alpha = 0, 
               category.names = c("Gat204_ChipSeq","30m-Up","30m-Down")) +
               scale_fill_gradient(low= "#F4FAFE",high = "#4981BF") +
               labs(title = "CHipSeq-Gat204_RNASeq at 30 min")+
               theme(legend.title = element_text(color = "black"),
                      legend.position = "bottom")
venn30
...
ggVennDiagram( hr2,  
               edge_lty = "dashed", edge_size = 1.2, 
               label_alpha = 0,
               category.names = c("Gat204_ChipSeq","2h-Up","2h-Down")) +
               scale_fill_gradient(low= "#F4FAFE",high = "#4981BF") + 
...
ggVennDiagram( hr4,  
               edge_lty = "dashed", edge_size = 1.2, 
               label_alpha = 0, 
               category.names = c("Gat204_ChipSeq","4h-Up","4h-Down")) +
               scale_fill_gradient(low= "#F4FAFE",high = "#4981BF") + 
...
ggVennDiagram(hr0,  
              edge_lty = "dashed", edge_size = 1.2, 
              label_alpha = 0, 
              category.names = c("Liv3_ChipSeq","0h-Up","0h-Down")) +
              scale_fill_gradient(low= "#F4FAFE",high = "#4981BF") +
...
venn30 <- ggVennDiagram( min30,  
               edge_lty = "dashed", edge_size = 1.2, 
               label_alpha = 0, 
               category.names = c("Liv3_ChipSeq","30m-Up","30m-Down")) +
               scale_fill_gradient(low= "#F4FAFE",high = "#4981BF") +
               labs(title = "CHipSeq-Liv3_RNASeq at 30 min")+
               theme(legend.title = element_text(color = "black"),
                      legend.position = "bottom")
venn30
...
ggVennDiagram( hr2,  
               edge_lty = "dashed", edge_size = 1.2, 
               label_alpha = 0,
               category.names = c("Liv3_ChipSeq","2h-Up","2h-Down")) +
               scale_fill_gradient(low= "#F4FAFE",high = "#4981BF") + 
...
ggVennDiagram( hr4,  
               edge_lty = "dashed", edge_size = 1.2, 
               label_alpha = 0, 
               category.names = c("Liv3_ChipSeq","4h-Up","4h-Down")) +
               scale_fill_gradient(low= "#F4FAFE",high = "#4981BF") + 
               labs(title = "CHipSeq-Liv3_RNASeq at 4 Hours")+
               theme(legend.title = element_text(color = "black"),
                      legend.position = "bottom")
