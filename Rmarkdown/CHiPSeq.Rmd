...
## Gat201 CHip Seq and 0 Hours RNASeq
...
ggVennDiagram(hr0,  
              ...
              label_alpha = 0, 
              category.names = c("Gat201-ChipSeq","0h-Up","0h-Down")) +
              scale_fill_gradient(low= "#F4FAFE",high = "#4981BF") +
              labs(title = "CHipSeq-Gat201_RNASeq at 0 Hours") +
...
## Gat201 CHip Seq and 30 min RNASeq
...
venn30 <- ggVennDiagram( min30,  
               edge_lty = "dashed", edge_size = 1.2, 
               label_alpha = 0, 
               category.names = c("Gat201-ChipSeq","30m-Up","30m-Down")) +
               scale_fill_gradient(low= "#F4FAFE",high = "#4981BF") +
               labs(title = "CHipSeq-Gat201_RNASeq at 30 mins")+
               theme(legend.title = element_text(color = "black"),
                      legend.position = "bottom")
venn30
...
## Gat201 CHip Seq and 2 Hours RNASeq
...
ggVennDiagram( hr2,  
               edge_lty = "dashed", edge_size = 1.2, 
               label_alpha = 0,
               category.names = c("Gat201-ChipSeq","2h-Up","2h-Down")) +
               scale_fill_gradient(low= "#F4FAFE",high = "#4981BF") + 
               labs(title = "CHipSeq-Gat201_RNASeq at 2 Hours")+
               theme(legend.title = element_text(color = "black"),
                      legend.position = "bottom")
...
## Gat201 CHip Seq and 4 Hours RNASeq
...
Int4b <- intersect(hr4$MGat201, hr4$X4HrHUp)
Int4b
...
ggVennDiagram( hr4,  
               edge_lty = "dashed", edge_size = 1.2, 
               label_alpha = 0, 
               category.names = c("Gat201-ChipSeq","4h-Up","4h-Down")) +
               scale_fill_gradient(low= "#F4FAFE",high = "#4981BF") + 
               labs(title = "CHipSeq-Gat201_RNASeq at 4 Hours")+
               theme(legend.title = element_text(color = "black"),
                      legend.position = "bottom")
...
## Gat204 CHip Seq and 0 Hours RNASeq
...
ggVennDiagram(hr0,  
              edge_lty = "dashed", edge_size = 1.2, 
              label_alpha = 0, 
              category.names = c("Gat204-ChipSeq","0h-Up","0h-Down")) +
              scale_fill_gradient(low= "#F4FAFE",high = "#4981BF") +
              labs(title = "CHipSeq-Gat204_RNASeq at 0 Hours") +
              theme(legend.title = element_text(color = "black"),
                    legend.position = "bottom") 
...
## Gat204 CHip Seq and 30 min RNASeq
...
venn30 <- ggVennDiagram( min30,  
               ...
               category.names = c("Gat201-ChipSeq","30m-Up","30m-Down")) +
               scale_fill_gradient(low= "#F4FAFE",high = "#4981BF") +
               labs(title = "CHipSeq-Gat204_RNASeq at 30 mins")+
               theme(legend.title = element_text(color = "black"),
                      legend.position = "bottom")
venn30
...
## Gat204 CHip Seq and 2 Hours RNASeq
...
ggVennDiagram( hr2,  
               ...
               category.names = c("Gat201-ChipSeq","2h-Up","2h-Down")) +
               scale_fill_gradient(low= "#F4FAFE",high = "#4981BF") + 
               labs(title = "CHipSeq-Gat204_RNASeq at 2 Hours")+
               theme(legend.title = element_text(color = "black"),
                      legend.position = "bottom")
...
## Gat204 CHip Seq and 4 Hours RNASeq
...
ggVennDiagram( hr4,  
               ...
               category.names = c("Gat201-ChipSeq","4h-Up","4h-Down")) +
               scale_fill_gradient(low= "#F4FAFE",high = "#4981BF") + 
               labs(title = "CHipSeq-Gat204_RNASeq at 4 Hours")+
               theme(legend.title = element_text(color = "black"),
                      legend.position = "bottom")
...
## Liv3 CHip Seq and 0 Hours RNASeq
...
ggVennDiagram(hr0,  
              edge_lty = "dashed", edge_size = 1.2, 
              label_alpha = 0, 
              category.names = c("Liv3-ChipSeq","0h-Up","0h-Down")) +
              scale_fill_gradient(low= "#F4FAFE",high = "#4981BF") +
              labs(title = "CHipSeq-Liv3_RNASeq at 0 Hours") +
              theme(legend.title = element_text(color = "black"),
                    legend.position = "bottom") 
...
## Liv3 CHip Seq and 30 min RNASeq
...
venn30 <- ggVennDiagram( min30,  
               edge_lty = "dashed", edge_size = 1.2, 
               label_alpha = 0, 
               category.names = c("Liv3-ChipSeq","30m-Up","30m-Down")) +
               scale_fill_gradient(low= "#F4FAFE",high = "#4981BF") +
               labs(title = "CHipSeq-Liv3_RNASeq at 30 mins")+
               theme(legend.title = element_text(color = "black"),
                      legend.position = "bottom")
venn30
...
## Liv3 CHip Seq and 2 Hours RNASeq
...
ggVennDiagram( hr2,  
               edge_lty = "dashed", edge_size = 1.2, 
               label_alpha = 0,
               category.names = c("Liv3-ChipSeq","2h-Up","2h-Down")) +
               scale_fill_gradient(low= "#F4FAFE",high = "#4981BF") + 
               labs(title = "CHipSeq-Liv3_RNASeq at 2 Hours")+
               theme(legend.title = element_text(color = "black"),
                      legend.position = "bottom")
...
## Liv3 CHip Seq and 4 Hours RNASeq
...
ggVennDiagram( hr4,  
               edge_lty = "dashed", edge_size = 1.2, 
               label_alpha = 0, 
               category.names = c("Liv3-ChipSeq","4h-Up","4h-Down")) +
               scale_fill_gradient(low= "#F4FAFE",high = "#4981BF") + 
