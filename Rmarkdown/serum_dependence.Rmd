...
- DEGdf_gat201del_30_vsSerum.txt
- DEGdf_gat201del_30_vsSerum_down2x_FDR5_ids.txt
- DEGdf_gat201del_30_vsSerum_down2x_FDR5.txt
- DEGdf_gat201del_30_vsSerum_up2x_FDR5_ids.txt
- DEGdf_gat201del_30_vsSerum_up2x_FDR5.txt
- DEGdf_gat201del_120_vsSerum.txt
- DEGdf_gat201del_120_vsSerum_down2x_FDR5_ids.txt
- DEGdf_gat201del_120_vsSerum_down2x_FDR5.txt
- DEGdf_gat201del_120_vsSerum_up2x_FDR5_ids.txt
- DEGdf_gat201del_120_vsSerum_up2x_FDR5.txt
- DEGdf_gat201del_240_vsSerum.txt
- DEGdf_gat201del_240_vsSerum_down2x_FDR5_ids.txt
- DEGdf_gat201del_240_vsSerum_down2x_FDR5.txt
- DEGdf_gat201del_240_vsSerum_up2x_FDR5_ids.txt
...
samplesheet <- 
  readxl::read_excel("../input_experiment/Gat201_samplesheet.xlsx") %>%
...
write_DEGdflist(DEGdf_WT_30_vsSerum, write_list = FALSE)
...
DEGdf_WT_120_vsSerum <- 
  dplyr::filter(deseq_df_GT_vsserum,
                GAT201_Time == "WT_120") %>%
  dplyr::select(-GAT201_Time)

write_DEGdflist(DEGdf_WT_120_vsSerum, write_list = FALSE)
...
DEGdf_WT_240_vsSerum <- 
  dplyr::filter(deseq_df_GT_vsserum,
                GAT201_Time == "WT_240") %>%
  dplyr::select(-GAT201_Time)

write_DEGdflist(DEGdf_WT_240_vsSerum, write_list = FALSE)
...
DEGdf_gat201del_30_vsSerum <- 
  dplyr::filter(deseq_df_GT_vsserum,
                GAT201_Time == "del_30") %>%
  dplyr::select(-GAT201_Time)

write_DEGdflist(DEGdf_gat201del_30_vsSerum, write_list = FALSE)
...
DEGdf_gat201del_120_vsSerum <- 
  dplyr::filter(deseq_df_GT_vsserum,
                GAT201_Time == "del_120") %>%
  dplyr::select(-GAT201_Time)

write_DEGdflist(DEGdf_gat201del_120_vsSerum, write_list = FALSE)
...
DEGdf_gat201del_240_vsSerum <- 
  dplyr::filter(deseq_df_GT_vsserum,
                GAT201_Time == "del_240") %>%
  dplyr::select(-GAT201_Time)

write_DEGdflist(DEGdf_gat201del_240_vsSerum, write_list = FALSE)
