...
genecluster_SSA1_k100 <- make_cluster_with_gene(gene = "CNAG_06443", k = 100)

genecluster_TEF1_k100 <- make_cluster_with_gene(gene = "CNAG_06125", k = 100)
all.equal(genecluster_SSA1_k100,genecluster_TEF1_k100)
...
```{r plot_log2FC_line_faceted_5select, fig.height = 6, fig.width = 3}
...
ggsave(filename = "../results/log2FC_line_multipanel_clusterselect.png",
       width = 2.5, height = 5)
```
...
```{r plot_log2FC_line_faceted_25genes, fig.height = 9, fig.width = 7.5}

my25genes <- read_tsv("../input_annotation/CryptoWakeup_25genes.txt")
...
ggsave(filename = "../results/log2FC_line_25genes.png",
       width = 7.5, height = 9)
```
