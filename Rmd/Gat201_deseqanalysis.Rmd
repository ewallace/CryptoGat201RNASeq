...
MA_0h <- results(dds_4h,lfcThreshold = 0.05, alpha = 0.05)
         plotMA(MA_4h, ylim=c(-5,5))
         print(plotMA)
         summary(MA_4h)
...
# Gene Annotation
```{r Gene Annotations}
GeneDescription <- readr::read_csv("~/Documents/GitHub/CryptoGat201RNASeq_draft/results_deseq/GeneDescription.csv")
