---
title: "Gat201 RNA Seq Deseqcanalysisc 2021-04-29"
author: "Liz Hughes"
date: "29/04/2021"
output:
  html_document:
...
```{r Load packages used for analysis, }
...
pheatmap(mat4h, main = "Top 50 genes at 4 hours", annotation_col=df, fontsize =10, fontsize_row = 4)
...
```{r Plot MA}
results_4h <- results(dds_4h,lfcThreshold = 0.05, alpha = 0.05)
