...
# Intersection of Hommer et al 2016 Gat201 Chip Seq with Gat20-1 RNA Seq
...
```{r venn_gat201ChipSeq_0hsRNASeq}
...
UP0h <- read_csv("~/Documents/GitHub/CryptoGat201RNASeq_draft/results_deseq/res_dds4h_resSigind.csv")
...
DE0hUPWT<- dplyr::inner_join(UP4hList,GeneList)
head(DE4hUP)
...
```{r venn_gat201ChipSeq_30minRNASeq}
...
```{r venn_gat201ChipSeq_2hrRNASeq}
...
```{r venn_gat201ChipSeq_4hrRNASeq}
