...
MAplot_dds0h <- plotMA(results_0h, 
       ylim=c(-5,5), alpha=.05)
dev.off()
...
readr::write_tsv("~/Documents/GitHub/CryptoGat201RNASeq_draft/results_deseq_2/Gat201_WT_DEseq2_genes0h.txt")

de_Gat201up_0h <- dplyr::filter(tresults_0h, estimate > 1, p.adjusted < 0.05) %>%
              dplyr::arrange(desc(estimate))
de_Gat201up_0h

readr::write_tsv(de_Gat201up_0h, "~/Documents/GitHub/CryptoGat201RNASeq_draft/results_deseq_2/Gat201up_DEseq2_padj0p05_0h.txt")
readr::write_lines(de_Gat201up_0h$gene, "~/Documents/GitHub/CryptoGat201RNASeq_draft/results_deseq_2/Gat201up_DEseq2_padj0p05_0h_genesonly.txt")

de_Gat201down_0h <- dplyr::filter(tresults_0h, estimate < -1, p.adjusted < 0.05) %>%
                dplyr::arrange(estimate)
de_Gat201down_0h

readr::write_tsv(de_Gat201down_0h, "~/Documents/GitHub/CryptoGat201RNASeq_draft/results_deseq_2/Gat201down_DEseq2_padj0p05_0h.txt")
readr::write_lines(de_Gat201down_0h$gene, "~/Documents/GitHub/CryptoGat201RNASeq_draft/results_deseq_2/Gat201down_DEseq2_padj0p05_0h_genesonly.txt")
...
MAplot_dds30m <- plotMA(results_30m, 
       ylim=c(-5,5), alpha=.05)
dev.off()
...
tresults_30m %>%  
dplyr::mutate(minus_log10_pvalue = -log10(p.value)) %>%
readr::write_tsv("~/Documents/GitHub/CryptoGat201RNASeq_draft/results_deseq_2/Gat201_WT_DEseq2_genes30m.txt")

de_Gat201up_30m <- dplyr::filter(tresults_30m, estimate > 0, p.adjusted < 0.05) %>%
              dplyr::arrange(desc(estimate))
de_Gat201up_30m

readr::write_tsv(de_Gat201up_30m, "~/Documents/GitHub/CryptoGat201RNASeq_draft/results_deseq_2/Gat201up_DEseq2_padj0p05_30m.txt")
readr::write_lines(de_Gat201up_30m$gene, "~/Documents/GitHub/CryptoGat201RNASeq_draft/results_deseq_2/Gat201up_DEseq2_padj0p05_30m_genesonly.txt")

de_Gat201down_30m <- dplyr::filter(tresults_30m, estimate < 0, p.adjusted < 0.05) %>%
                dplyr::arrange(estimate)
de_Gat201down_30m

readr::write_tsv(de_Gat201down_30m, "~/Documents/GitHub/CryptoGat201RNASeq_draft/results_deseq_2/Gat201down_DEseq2_padj0p05_30m.txt")
readr::write_lines(de_Gat201down_30m$gene, "~/Documents/GitHub/CryptoGat201RNASeq_draft/results_deseq_2/Gat201down_DEseq2_padj0p05_30m_genesonly.txt")
...
MAplot_dds2h <- plotMA(results_2h, 
       ylim=c(-5,5), alpha=.05)
dev.off()
...
tresults_2h %>%  
dplyr::mutate(minus_log10_pvalue = -log10(p.value)) %>%
readr::write_tsv("~/Documents/GitHub/CryptoGat201RNASeq_draft/results_deseq_2/Gat201_WT_DEseq2_genes2h.txt")

de_Gat201up_2h <- dplyr::filter(tresults_2h, estimate > 0, p.adjusted < 0.05) %>%
              dplyr::arrange(desc(estimate))
de_Gat201up_2h

readr::write_tsv(de_Gat201up_2h, "~/Documents/GitHub/CryptoGat201RNASeq_draft/results_deseq_2/Gat201up_DEseq2_padj0p05_2h.txt")
readr::write_lines(de_Gat201up_2h$gene, "~/Documents/GitHub/CryptoGat201RNASeq_draft/results_deseq_2/Gat201up_DEseq2_padj0p05_2h_genesonly.txt")

de_Gat201down_2h <- dplyr::filter(tresults_2h, estimate < 0, p.adjusted < 0.05) %>%
                dplyr::arrange(estimate)
de_Gat201down_2h

readr::write_tsv(de_Gat201down_2h, "~/Documents/GitHub/CryptoGat201RNASeq_draft/results_deseq_2/Gat201down_DEseq2_padj0p05_2h.txt")
readr::write_lines(de_Gat201down_2h$gene, "~/Documents/GitHub/CryptoGat201RNASeq_draft/results_deseq_2/Gat201down_DEseq2_padj0p05_2h_genesonly.txt")
...
resultsNames(dds_4h)
results_4h <- results(dds_4h, name="GAT201_No_vs_Yes", alpha=.05)

jpeg(file= "~/Documents/GitHub/CryptoGat201RNASeq_draft/results_deseq_2/MAPlot_dds4ha.jpeg")
...
results_4h$Symbol <- paste0("Symbol", 1:6795)
plotMA(results_4h, ylim = c(-5,5))
with(subset(res, symbol == "1551"), {
  points(baseMean, log2FoldChange, col = "dodgerblue", cex = 2, lwd = 2)
  text(baseMean, log2FoldChange, "1551", pos = 2, col = "dodgerblue")
})
res4h_df <- results_4h %>%
    as.data.frame() %>%
    dplyr::mutate(significant = padj < 0.5)

res4h_labelled <- res4h_df %>%
    dplyr::filter(significant)
    
ggplot(res4h_df, aes(x=log2(baseMean), y=log2FoldChange, colour=significant)) +
    geom_point() +
    ggrepel::geom_label_repel(data=res4h_labelled, aes(label=Symbol)) +
    theme_bw()
...
tresults_4h %>%  
dplyr::mutate(minus_log10_pvalue = -log10(p.value)) %>%
readr::write_tsv("~/Documents/GitHub/CryptoGat201RNASeq_draft/results_deseq_2/Gat201_WT_DEseq2_genes4h.txt")
```
...
```{r de_Gat201up_4h}
de_Gat201up_4h <- dplyr::filter(tresults_4h, estimate > 0, p.adjusted < 0.05) %>%
              dplyr::arrange(desc(estimate))
de_Gat201up_4h

readr::write_tsv(de_Gat201up_4h, "~/Documents/GitHub/CryptoGat201RNASeq_draft/results_deseq_2/Gat201up_DEseq2_padj0p05_4h.txt")
readr::write_lines(de_Gat201up_4h$gene, "~/Documents/GitHub/CryptoGat201RNASeq_draft/results_deseq_2/Gat201up_DEseq2_padj0p05_4h_genesonly.csv")
...
```{r de_Gat201down_4h}
de_Gat201down_4h <- dplyr::filter(tresults_4h, estimate < 0, p.adjusted < 0.05) %>%
                dplyr::arrange(estimate)
de_Gat201down_4h

readr::write_tsv(de_Gat201down_4h, "~/Documents/GitHub/CryptoGat201RNASeq_draft/results_deseq_2/Gat201down_DEseq2_padj0p05_4h.txt")
readr::write_lines(de_Gat201down_4h$gene, "~/Documents/GitHub/CryptoGat201RNASeq_draft/results_deseq_2/Gat201down_DEseq2_padj0p05_4h_genesonly.txt")
```
...
```{r}
ggsave("~/Documents/GitHub/CryptoGat201RNASeq_draft/results_deseq_2/Gat201vWT_4h.png",
       width = 5,height=5)
```
...
```{r}
ggsave("~/Documents/GitHub/CryptoGat201RNASeq_draft/results_deseq_2/Gat201vWT_4hsp.png",
       width = 5,height=5)
```
...
```{r prepare Gat201upGeneList}
Gat201up_genesonly <- readr::read_csv("~/Documents/GitHub/CryptoGat201RNASeq_draft/results_deseq_2/Gat201up_DEseq2_padj0p05_4h_genesonly.csv")

head(Gat201up_genesonly)

```

# Match up-regulated genes to annotation file
 
```{r Match DE genes lists to GeneList 4h}
Gat201_4hUP<- dplyr::inner_join(Gat201up_genesonly,GeneList)
head(Gat201_4hUP)
write.csv(Gat201_4hUP, file = "~/Documents/GitHub/CryptoGat201RNASeq_draft/results_deseq_2/Gat201_4hUP.csv")
summary(Gat201_4hUP)
